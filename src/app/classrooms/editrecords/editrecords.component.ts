  ...
  updateForm() {
    ...
    dialogRef.afterClosed().subscribe((result) => {
      ...
      if (this.confirmMsgY === "yes") {
        ...
        this.crudApi.UpdateClassRoom(id, "free");

        this.crudApi.UpdateClassRecord(this.editForm.value); // Update student data using CRUD API
        this.toastr.success(
          this.editForm.controls["className"].value + " updated successfully"
...
@Component({
  ...
  template: ` <h1 mat-dialog-title>Confirmation</h1>
    ...
    <div mat-dialog-actions>
      ...
      <button mat-button [mat-dialog-close]="data.confirmMsgY" cdkFocusInitial>
        Yes
      </button>
    </div>`,
})
